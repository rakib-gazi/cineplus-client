...
export default function OriginalsClient() {
  ...
  const combinedShows: ExtendedShow[] = mappedDynamicShows;

  // Filter shows
  const filteredOriginals = combinedShows.filter((show) => {
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 border-b border-white/5 pb-8">
        <div>
          <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tight mb-2">
            Cineplus <span className="text-primary">Originals</span>
          </h1>
              ...
              {activeShow && (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <a
                      href={activeShow.link || "https://www.youtube.com/@cineplusbd"}
                      target="_blank"
